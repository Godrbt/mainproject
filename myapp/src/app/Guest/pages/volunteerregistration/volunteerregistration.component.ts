...
export class VolunteerregistrationComponent {
  ...
  onSubmit() {
    ...
    volunteerformdata.append('volunteer_contact', volunteerData.volunteer_contact);
    volunteerformdata.append('volunteer_email', volunteerData.volunteer_email);
    volunteerformdata.append('volunteer_gender', volunteerData.volunteer_gender);
    volunteerformdata.append('volunteer_password', volunteerData.volunteer_password);
    volunteerformdata.append('volunteer_address', volunteerData.volunteer_address);
    volunteerformdata.append('loc_id', volunteerData.loc_id);



    axios.post('http://localhost:5000/volunteerregistration/', volunteerformdata).then((response) => {
